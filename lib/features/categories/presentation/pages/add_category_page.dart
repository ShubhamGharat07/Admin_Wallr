// // lib/features/categories/presentation/pages/add_category_page.dart
...
//         isActive: _isActive,
//         coverImageBytes:
//             _coverImageBytes != null ? List<int>.from(_coverImageBytes!) : null,
...
//           AppLogger.error('CategoryError on page: ${state.message}', tag: 'AddCategoryPage');
//           ScaffoldMessenger.of(context).showSnackBar(
//             SnackBar(
...
//     final padding = AdminDimensions.contentPadding(context);
...
//             // ── Main layout: single column on mobile, row on desktop/tablet
//             isMobile
//                 ? Column(
...
//         Text('Add New Category', style: AdminTextStyles.headlineLg(context)),
//       ],
//     );
//   }
...
//                 Text(
//                   title.toUpperCase(),
//                   style: AdminTextStyles.labelMd(context).copyWith(
//                     color: AdminColors.gold,
//                     letterSpacing: 0.8,
//                   ),
//                 ),
...
//             crossAxisAlignment: CrossAxisAlignment.start,
//             children: [
//               Text(label, style: AdminTextStyles.bodyMd(context)),
